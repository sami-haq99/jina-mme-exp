...
sentences = ['a grey cat is cuddling with an orange cat on a blanket.', 'a calico cat is cuddling with an orange dog on a blanket.', 'Eine graue Katze kuschelt mit einer orangefarbenen Katze auf einer Decke.']
